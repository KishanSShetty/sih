...
def train_production_ready():  
    ...
    print(f"Dataset size after dedup: {len(full_df)}")
    ...
    vectorizer = TfidfVectorizer(
        max_features=15000, # Increased features for detail
        stop_words='english', 
    ...
    # We use C=2.0 to give slightly more freedom to fit the complex decision boundary
    # class_weight='balanced' handles the remaining imbalance
