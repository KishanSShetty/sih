...
def train_max_performance():  
    print("Starting Max Performance Training (Balanced)...")  
    ...
    # Vectorize - Enhanced n-grams
    # 1. ngram_range=(1, 2): Captures "verify account" as a unit, not just "verify" and "account".
    # 2. min_df=2: Ignores typos/noise.
    ...
    # Model - Balanced
    # 'class_weight="balanced"': This effectively tells sklearn to weight the classes inversely proportional to class frequencies.
    # Since we manually added safe data, we are close to 50/50, so this should find the optimal decision boundary.
